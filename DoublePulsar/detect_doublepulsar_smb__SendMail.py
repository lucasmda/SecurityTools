...
# me == E-mail do remetente
# you == -Email do destinatário
me = "T-SystemsBrazilCERT@abner.almeida@t-systems.com.br"
you = "abner.almeida@t-systems.com.br"
...
<html>
  <head></head>
  <body>
    <p>O DoublePulsar SMB foi detectado no IP """+ip+"""<br>
	Remover o ativo da rede ASAP!!!
    </p>
  </body>
</html>
"""
...
s = smtplib.SMTP('relay.sp.t-systems.com.br')
